...
import 'package:first/widgets/weekly_chart.dart';
        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("From Health Center",style: TextStyle(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      buildInfoTextWithPercentage(percentage: "6.43%",
                      title: "From Last Week",
                      ),buildInfoTextWithPercentage(percentage: "9.43%",
                      title: "Recovery Rate",
                      ),
            ...
            Container(
              ...
              borderRadius: BorderRadius.circular(20),
                boxShadow: [BoxShadow(offset: Offset(0,21),
                blurRadius: 54,
                color: Colors.black.withOpacity(0.05),
                ),
                ],
              ...
              child: Column(
                ...
                SizedBox(height: 10,),
                SvgPicture.asset("assets/icons/map.svg",height: 120,)
                ],
              ),
            )
          ],
